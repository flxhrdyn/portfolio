...
export default function ProfilePhoto() {
  ...
  // When NOT hovered: 0deg (flat normal photo)
  // When HOVERED: smoothly transitions to Scale AI isometric angle (-26deg Y, 14deg X) with gyro tilt
      ...
      >
        ...
        <div className="scale-sheet sheet-back-3" aria-hidden="true">
          <svg className="sheet-canvas-svg" viewBox="0 0 540 340" fill="none" stroke="currentColor">
            ...
            {/* Flowing Splines converging from photo to output ports */}
        ...
        <div className="scale-sheet sheet-front-1" aria-hidden="true">
          <svg className="sheet-canvas-svg" viewBox="0 0 540 340" fill="none" stroke="currentColor">
            ...
            {/* Orthogonal Dotted Rays Projecting From Features */}
