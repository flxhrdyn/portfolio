        ...
        <div className="contact-minimal-canvas">
          ...
          {reduceMotion ? (
            <div className="contact-minimal-right">
              ...
              >
                <span className="row-left-group">
                  <svg className="row-icon" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="10" r="6.8" />
                    <circle cx="9.5" cy="8.8" r="0.9" fill="currentColor" stroke="none" />
                    <circle cx="14.5" cy="8.8" r="0.9" fill="currentColor" stroke="none" />
                    <path d="M9.5 12a2.6 2.6 0 0 0 5 0" />
                    <path d="M3.2 13.5c-.7.6-.8 1.6-.2 2.3.6.7 1.6.8 2.3.2l2.4-2" />
                    <path d="M4.5 12.2l2.2 1.6" />
                    <path d="M5.8 11.2l1.6 1.6" />
                    <path d="M20.8 13.5c.7.6.8 1.6.2 2.3-.6.7-1.6.8-2.3.2l-2.4-2" />
                    <path d="M19.5 12.2l-2.2 1.6" />
                    <path d="M18.2 11.2l-1.6 1.6" />
                  </svg>
